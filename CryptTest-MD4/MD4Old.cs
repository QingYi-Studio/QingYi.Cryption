...
namespace CryptTest_MD4
{
    ...
    internal class MD4Old
    {
        ...
        /// <summary>
        /// Continues an MD4 message digest using the input byte.<br></br>
        /// 使用输入字节继续执行MD4计算。
        /// </summary>
        /// <param name = "b">byte to input<br></br>输入的字节</param>
        private void EngineUpdate(byte b)
        {
            // 计算仍未散列的字节数; ie. 存在于缓冲区中
