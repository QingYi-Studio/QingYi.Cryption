...
namespace Caesar
{
    ...
    public class CaesarCrypto
    {
        ...
        /// </param>
        /// <returns>
        /// The encrypted string. Each character in the string is shifted by the specified amount.|加密后的字符串。该字符串中的每个字符都被移位了指定的位移量。
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// The decrypted string. Each character in the string is shifted by the specified amount to restore the original text.|解密后的字符串。该字符串中的每个字符都被移位了指定的位移量，恢复到原始文本。
        /// </returns>
